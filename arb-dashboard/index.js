        ...
        <div class="tab-container">
            ...
            <div class="tab-content" id="balances-content">
                <div class="balances-grid">
                    ...
                    <div class="balance-card thrillzz">
                        <div class="balance-label">Thrillzz</div>
                        <div class="balance-value" id="thrillzz-balance">$0.00</div>
                    </div>
                    <div class="balance-card sportzino">
                        <div class="balance-label">Sportzino</div>
                        <div class="balance-value" id="sportzino-balance">$0.00</div>
                    </div>
                    <div class="balance-card 4cx">
                        <div class="balance-label">4cx</div>
                        <div class="balance-value" id="4cx-balance">$0.00</div>
                    </div>
                </div>
